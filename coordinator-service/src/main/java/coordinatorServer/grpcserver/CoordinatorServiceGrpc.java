...
public final class CoordinatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpcserver.UpdateTaskRequest,
      grpcserver.UpdateTaskResponse> getUpdateTaskMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateTask",
      requestType = grpcserver.UpdateTaskRequest.class,
      responseType = grpcserver.UpdateTaskResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpcserver.UpdateTaskRequest,
      grpcserver.UpdateTaskResponse> getUpdateTaskMethod() {
    io.grpc.MethodDescriptor<grpcserver.UpdateTaskRequest, grpcserver.UpdateTaskResponse> getUpdateTaskMethod;
      ...
      synchronized (CoordinatorServiceGrpc.class) {
        if ((getUpdateTaskMethod = CoordinatorServiceGrpc.getUpdateTaskMethod) == null) {
          CoordinatorServiceGrpc.getUpdateTaskMethod = getUpdateTaskMethod = 
              io.grpc.MethodDescriptor.<grpcserver.UpdateTaskRequest, grpcserver.UpdateTaskResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CoordinatorService", "updateTask"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcserver.UpdateTaskRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcserver.UpdateTaskResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpcserver.HeartBeatRequest,
      grpcserver.HeartBeatResponse> getSendHeartBeatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendHeartBeat",
      requestType = grpcserver.HeartBeatRequest.class,
      responseType = grpcserver.HeartBeatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpcserver.HeartBeatRequest,
      grpcserver.HeartBeatResponse> getSendHeartBeatMethod() {
    io.grpc.MethodDescriptor<grpcserver.HeartBeatRequest, grpcserver.HeartBeatResponse> getSendHeartBeatMethod;
      ...
      synchronized (CoordinatorServiceGrpc.class) {
        if ((getSendHeartBeatMethod = CoordinatorServiceGrpc.getSendHeartBeatMethod) == null) {
          CoordinatorServiceGrpc.getSendHeartBeatMethod = getSendHeartBeatMethod = 
              io.grpc.MethodDescriptor.<grpcserver.HeartBeatRequest, grpcserver.HeartBeatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CoordinatorService", "sendHeartBeat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcserver.HeartBeatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcserver.HeartBeatResponse.getDefaultInstance()))
  ...
  public static abstract class CoordinatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void updateTask(grpcserver.UpdateTaskRequest request,
        io.grpc.stub.StreamObserver<grpcserver.UpdateTaskResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getUpdateTaskMethod(), responseObserver);
    }

    /**
     */
    public void sendHeartBeat(grpcserver.HeartBeatRequest request,
        io.grpc.stub.StreamObserver<grpcserver.HeartBeatResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpcserver.UpdateTaskRequest,
                grpcserver.UpdateTaskResponse>(
                  this, METHODID_UPDATE_TASK)))
          .addMethod(
            getSendHeartBeatMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                grpcserver.HeartBeatRequest,
                grpcserver.HeartBeatResponse>(
  ...
  public static final class CoordinatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CoordinatorServiceBlockingStub> {
    ...
    /**
     */
    public grpcserver.UpdateTaskResponse updateTask(grpcserver.UpdateTaskRequest request) {
    ...
    /**
     */
    public grpcserver.HeartBeatResponse sendHeartBeat(grpcserver.HeartBeatRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CoordinatorServiceFutureStub extends io.grpc.stub.AbstractStub<CoordinatorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpcserver.UpdateTaskResponse> updateTask(
        grpcserver.UpdateTaskRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpcserver.HeartBeatResponse> sendHeartBeat(
        grpcserver.HeartBeatRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_TASK:
          serviceImpl.updateTask((grpcserver.UpdateTaskRequest) request,
              (io.grpc.stub.StreamObserver<grpcserver.UpdateTaskResponse>) responseObserver);
          break;
        case METHODID_SEND_HEART_BEAT:
          serviceImpl.sendHeartBeat((grpcserver.HeartBeatRequest) request,
              (io.grpc.stub.StreamObserver<grpcserver.HeartBeatResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CoordinatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpcserver.Coordinator.getDescriptor();
    }
